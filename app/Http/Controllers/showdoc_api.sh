...
# 
api_key="a68685ea74595f30cc69003c350d90ab2061685099" 			#api_key
api_token="b6f34c1c0e31c3a5bc945a281ab986651613672661" 	#api_token
url="https://doc.zuli.tech/server/?s=/api/open/fromComments" #同步到的url。使用www.showdoc.cc的不需要修改，使用开源版的请修改
#
#
#
#
